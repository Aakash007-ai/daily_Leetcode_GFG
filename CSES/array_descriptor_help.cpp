...
template <class T>
void vprint(vector<vector<T>> vec)
{
...
template <class T, class P>
void vprint(unordered_map<T, P> m)
{
    cerr << "[";
    for (auto i : m)
        vprint(i);
...
template <class T, class P>
void vprint(map<T, vector<pair<T, P>>> graph)
{
    for (auto i : graph)
    {
        cerr << "[";
