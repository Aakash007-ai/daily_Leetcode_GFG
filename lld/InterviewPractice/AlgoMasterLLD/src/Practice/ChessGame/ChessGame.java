package Practice.ChessGame;

import java.util.Scanner;

import Practice.ChessGame.entities.Player;
...
public class ChessGame {
    ...
    public void setPlayers(String playerWhiteName, String playerBlackName){
        this.whitePlayer = new Player(Color.WHITE, playerBlackName);
        this.blackPlayer = new Player(Color.BLACK, playerBlackName);
